...
* график сделки (`ui/widgets/trade_chart.dart`) сохраняет визуальный язык
  ...
  пульсирующий маркер цены — но рисует **реальные свечи**, по которым скринер
  посчитал сигнал, с тегом таймфрейма в углу. Разметка (BOS/CHoCH, FVG)
  наносится только там, где скринер её действительно нашёл; синтетических
